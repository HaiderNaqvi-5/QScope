...
type Report = { score: number; dependency_count: number; findings: { title: string; severity: string; status: string; file_path?: string; line?: string; message: string }[]; new_findings: number; existing_findings: number };
    ...
    <main className="min-h-screen bg-slate-50 px-4 py-12 dark:bg-slate-950">
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        {report && <section className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-2 text-sm text-slate-500">{report.new_findings} new · {report.existing_findings} existing findings · {report.dependency_count} dependencies inventoried</p>
